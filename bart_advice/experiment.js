    ...
    var Ins_block = {
		...
		"<div class=\"inst\">" +
		"<p>이 과제에는 여러개의 풍선이 나타나는데, 풍선은 파랑색, 주황색, 노랑색으로 구성되어있습니다. </p> <p>풍선은 바로 터질 수도 있고 최대 크기까지 커질 수도 있습니다. </p>" +
    ...
    var Ins_block1 = {
        type: 'text',
		text: "<div class=\"display_stage\">" +
		"<div class=\"taskname\"><strong>1 구간</strong></div>" +
		"<div class=\"inst\">" +
		"<p>첫번째 구간입니다.</p><br><p>이 풍선과제에서는 조언자가 조언을 해줍니다. <br><br> 조언의 방식은 각 풍선마다 최대로 누를 수 있는 수를 4구간으로 나누어 <br><br> 어느 구간에서 터질 가능성이 높은지에 대한 예측정보를 알려줍니다. </p> " +
		"<p>단, 예측 정보의 정확성은 구간마다 달라집니다. 모두 정확히 예측할수도 있고, 그렇지 못할 수도 있습니다. </p>" +
    ...
    var Ins_block2 = {
        type: 'text',
		text: "<div class=\"display_stage\">" +
		"<div class=\"taskname\"><strong>2 구간</strong></div>" +
		"<div class=\"inst\">" +
		"<p> 두번째 구간에서는 첫번째 구간과 정확도가 달라집니다. 조언을 잘보고 결정해야 합니다. <br><br> 이것만 제외하면 첫번째 구간과 동일한 절차로 진행됩니다. </p> " +
		"<p>예측정보는 풍선누르기 전에 나타납니다. 잘 읽고 최대한 많은 수익금을 얻도록 노력하세요!</p>"  +
		"</div>" +
		"<div class=\"clickspace\">" +
		"<p><strong>스페이스 바</strong>를 눌러 시작하시오.</p>" +
    ...
    var Ins_block3 = {
        type: 'text',
		text: "<div class=\"display_stage\">" +
		"<div class=\"taskname\"><strong>3 구간</strong></div>" +
		"<div class=\"inst\">" +
		"<p> 세번째 구간에서도 정확도가 달라집니다. 조언을 잘보고 결정해야 합니다. <br><br> 이것만 제외하면 첫번째 구간과 동일한 절차로 진행됩니다. </p> " +
		"<p>예측정보는 풍선누르기 전에 나타납니다. 잘 읽고 최대한 많은 수익금을 얻도록 노력하세요!</p>"  +
		"</div>" +
		"<div class=\"clickspace\">" +
		"<p><strong>스페이스 바</strong>를 눌러 시작하시오.</p>" +
