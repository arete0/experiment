    ...
    var Ins_block2 = {
		...
		"<div class=\"inst\">" +
		"<p> 두번째 구간에서는 첫번째 구간과 정확도가 달라집니다. 조언을 잘보고 결정해야 합니다. 이것만 제외하면 첫번째 구간과 동일한 절차로 진행됩니다. </p> " +
		"<p>예측정보는 풍선누르기 전에 나타납니다. 잘 읽고 최대한 많은 수익금을 얻도록 노력하세요!</p>"  +
		"</div>" +
		"<div class=\"clickspace\">" +
		"<p><strong>스페이스 바</strong>를 눌러 시작하시오.</p>" +
    ...
    var Ins_block3 = {
		...
		"<div class=\"inst\">" +
		"<p> 세번째 구간에서도 정확도가 달라집니다. 조언을 잘보고 결정해야 합니다. 이것만 제외하면 첫번째 구간과 동일한 절차로 진행됩니다. </p> " +
		"<p>예측정보는 풍선누르기 전에 나타납니다. 잘 읽고 최대한 많은 수익금을 얻도록 노력하세요!</p>"  +
		"</div>" +
		"<div class=\"clickspace\">" +
		"<p><strong>스페이스 바</strong>를 눌러 시작하시오.</p>" +
