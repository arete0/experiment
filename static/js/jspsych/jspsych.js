  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.append('<div class = jspsych-instructions-nav><p>아래의 버튼을 누르면 전체화면으로 실험을 시작합니다.</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">실험 시작</button></div>');
